 ...
 *
 * Usage:
 *   node skills/knowledge-wiki/enrich/wiki-summary.mjs list-stale
 *   node skills/knowledge-wiki/enrich/wiki-summary.mjs create <source-path> [--at <ISO timestamp>]
 *   node skills/knowledge-wiki/enrich/wiki-summary.mjs delete-concept <summary-rel-path> <concept-slug>
 *   node skills/knowledge-wiki/enrich/wiki-summary.mjs insert-concept <summary-rel-path> <concept-slug> <display-name> <description>
 *
...
function cmdCreate(args) {
  ...
  if (!sourceRel) {
    console.error(
      "Usage: node skills/knowledge-wiki/enrich/wiki-summary.mjs create <source-path> [--at <ISO timestamp>]",
    );
    process.exit(1);
  }
...
function cmdDeleteConcept(args) {
  ...
  if (!relPath || !slug) {
    console.error(
      "Usage: node skills/knowledge-wiki/enrich/wiki-summary.mjs delete-concept - | <summary-rel-path> <concept-slug>",
    );
    process.exit(1);
  }
...
function cmdInsertConcept(args) {
  ...
  if (!relPath || !slug || !displayName || !description) {
    console.error(
      "Usage: node skills/knowledge-wiki/enrich/wiki-summary.mjs insert-concept - | <summary-rel-path> <concept-slug> <display-name> <description|->\n  Use - as first arg to read all fields from stdin; or pass - as 4th arg to read only the description.",
    );
    process.exit(1);
  }
