...
description: Reference for writing any document an agent consumes — skills, AGENTS.md / CLAUDE.md, docs reached by a pointer. Use when creating or editing skills, or modifying AGENTS.md or CLAUDE.md.
...
3. **Disclosed reference** — pushed out into a separate file, reached by a context pointer, loaded only when the pointer fires. Spans a sibling file in the same folder (like this skill's `GLOSSARY.md`) through fully external reference that lives anywhere and any document can point at.
