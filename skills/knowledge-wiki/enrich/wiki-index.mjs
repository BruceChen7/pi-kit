 ...
 *
 * Usage:
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs sort
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs read-concepts
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs read-summaries [--all]
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs upsert-concept <slug> "<display-name>" "<description>"
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs delete-concept <slug>
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs upsert-summary "<rel-path>" "<description>"
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs delete-summary "<rel-path>"
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs find-missing-summaries
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs find-missing-concepts
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs delete-dead-links
 *   node skills/knowledge-wiki/enrich/wiki-index.mjs split-daily-shards
 *
