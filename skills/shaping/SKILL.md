...
Use Pi-native paths for all shaping artifacts:

- **Frame**: `.pi/plans/<repo>/shaping/YYYY-MM-DD-<topic>-frame.md`
- **Shaping doc**: `.pi/plans/<repo>/shaping/YYYY-MM-DD-<topic>-shaping.md`
- **Slices doc**: `.pi/plans/<repo>/shaping/YYYY-MM-DD-<topic>-slices.md`
- **Slice plans**: `.pi/plans/<repo>/plan/YYYY-MM-DD-<topic>-v<N>.md`
...
- **Slice plans**: Individual files (`...-v1.md`, `...-v2.md`, etc.) with implementation details
