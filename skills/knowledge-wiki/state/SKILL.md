...
- `../scripts/wiki-state.mjs` — state management
- `../scripts/wiki-index.mjs` — index management
...
node ../scripts/wiki-state.mjs find-unprocessed-summaries knowledge-wiki-concept --base-path /path/to/knowledge-base
...
node ../scripts/wiki-state.mjs set-last-run knowledge-wiki-concept --base-path /path/to/knowledge-base
...
node ../scripts/wiki-index.mjs read-concepts --base-path /path/to/knowledge-base
node ../scripts/wiki-index.mjs read-summaries --base-path /path/to/knowledge-base

# Insert/update/delete entries
node ../scripts/wiki-index.mjs upsert-concept <slug> "<display-name>" "<description>" --base-path /path/to/knowledge-base
node ../scripts/wiki-index.mjs delete-concept <slug> --base-path /path/to/knowledge-base
node ../scripts/wiki-index.mjs upsert-summary "<rel-path>" "<description>" --base-path /path/to/knowledge-base
node ../scripts/wiki-index.mjs delete-summary "<rel-path>" --base-path /path/to/knowledge-base
